...
;  Global Symbols
;-----------------------------------------------
export   CHILD_3_EnableInt
export  _CHILD_3_EnableInt
export   CHILD_3_DisableInt
export  _CHILD_3_DisableInt
export   CHILD_3_Start
export  _CHILD_3_Start
export   CHILD_3_Stop
export  _CHILD_3_Stop
export   CHILD_3_bReadRxData
export  _CHILD_3_bReadRxData
export   CHILD_3_bReadRxStatus
export  _CHILD_3_bReadRxStatus

; Old function name convension, do not use.
; These will be removed in a future release.
export  bCHILD_3_ReadRxData
export _bCHILD_3_ReadRxData
export  bCHILD_3_ReadRxStatus
export _bCHILD_3_ReadRxStatus

;-----------------------------------------------
; High Level RX functions
;-----------------------------------------------

export  CHILD_3_cGetChar
export _CHILD_3_cGetChar
export  CHILD_3_cReadChar
export _CHILD_3_cReadChar
export  CHILD_3_iReadChar
export _CHILD_3_iReadChar

IF (CHILD_3_RXBUF_ENABLE)
export  CHILD_3_CmdReset
export _CHILD_3_CmdReset
export  CHILD_3_bCmdCheck
export _CHILD_3_bCmdCheck
export  CHILD_3_bCmdLength
export _CHILD_3_bCmdLength
export  CHILD_3_bErrCheck
export _CHILD_3_bErrCheck

export  CHILD_3_szGetParam
export _CHILD_3_szGetParam
export  CHILD_3_szGetRestOfParams
export _CHILD_3_szGetRestOfParams

;-----------------------------------------------
;  Variables
;-----------------------------------------------

AREA CHILD_3_RAM(RAM,REL,CON)
 ptrParam:   			BLK  1
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: CHILD_3_EnableInt
;
;  DESCRIPTION:
...
_CHILD_3_EnableInt:
   ...
   M8C_EnableIntMask CHILD_3_INT_REG, CHILD_3_bINT_MASK
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: CHILD_3_DisableInt
;
;  DESCRIPTION:
...
_CHILD_3_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   M8C_DisableIntMask CHILD_3_INT_REG, CHILD_3_bINT_MASK
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: CHILD_3_Start(BYTE bParity)
;
;  DESCRIPTION:
...
_CHILD_3_Stop:
   RAM_PROLOGUE RAM_USE_CLASS_1
   and   REG[CHILD_3_CONTROL_REG], ~bfCONTROL_REG_START_BIT
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: CHILD_3_bReadRxData
;
;  DESCRIPTION:
...
;
 CHILD_3_bReadRxData:
_CHILD_3_bReadRxData:
 bCHILD_3_ReadRxData:
_bCHILD_3_ReadRxData:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov A, REG[CHILD_3_RX_BUFFER_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: CHILD_3_bReadRxStatus
;
;  DESCRIPTION:
...
;    functions.
;
 CHILD_3_bReadRxStatus:
_CHILD_3_bReadRxStatus:
 bCHILD_3_ReadRxStatus:
_bCHILD_3_ReadRxStatus:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov A,  REG[CHILD_3_CONTROL_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: CHILD_3_cGetChar
;
;  DESCRIPTION:
...
.getChar_Loop:
   tst REG[CHILD_3_CONTROL_REG],CHILD_3_RX_REG_FULL   ; Check if a character is ready
   jz  .getChar_Loop                                        ; If not loop

   mov A, REG[CHILD_3_RX_BUFFER_REG]             ; Get character
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: CHILD_3_cReadChar
;
;  DESCRIPTION:
;     Read character from UART RX port.
;
...
_CHILD_3_cReadChar:
   ...
   mov  A,REG[CHILD_3_CONTROL_REG]                         ; Get Status of RX
   push A
   and  A,CHILD_3_RX_COMPLETE                              ; Check if a character is ready
   jnz  .RX_DATA_RDY                                       ; Data Ready go read it.
   pop  A
   jmp  .RX_NO_VALID_CHAR

.RX_DATA_RDY:
   mov  A,REG[CHILD_3_RX_BUFFER_REG]                       ; Read data first, then
   swap A,X                                                ; determine if data is valid

   pop  A                                                  ; Check for errors
   and  A,(CHILD_3_RX_PARITY_ERROR | CHILD_3_RX_FRAMING_ERROR)
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: CHILD_3_iReadChar
;
...
_CHILD_3_iReadChar:
   ...
   and  A,(CHILD_3_RX_ERROR|CHILD_3_RX_REG_FULL)
   push A
   and  A,CHILD_3_RX_COMPLETE                              ; Check if a character is ready
   jnz  .RX_GET_DATA                                       ; Data Ready go read it.
   pop  A
   or   A,CHILD_3_RX_NO_DATA                               ; Add no data flag
   swap A,X
   jmp  End_CHILD_3_iReadChar

.RX_GET_DATA:
   pop  A
   and  A,CHILD_3_RX_ERROR
   swap A,X
   mov  A,REG[CHILD_3_RX_BUFFER_REG]                       ; Read data first, then
                                                           ; determine if data is valid

 End_CHILD_3_iReadChar:
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
;-----------------------------------------------------------------------------
;  FUNCTION NAME: CHILD_3_CmdReset
;
;  DESCRIPTION:
...
_CHILD_3_CmdReset:
   ...
   RAM_SETPAGE_CUR >CHILD_3_aRxBuffer
   mov [CHILD_3_aRxBuffer], 0x00
   RAM_SETPAGE_CUR >ptrParam
   mov [ptrParam],0x00
   RAM_SETPAGE_CUR >CHILD_3_bRxCnt
   mov [CHILD_3_bRxCnt], 0x00
   and [CHILD_3_fStatus], 0x00
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: CHILD_3_bCmdCheck
;
;  DESCRIPTION:
...
_CHILD_3_bCmdCheck:
   RAM_PROLOGUE RAM_USE_CLASS_4
   RAM_SETPAGE_CUR >CHILD_3_fStatus
   mov A,  [CHILD_3_fStatus]
   and A, CHILD_3_RX_BUF_CMDTERM                 ; Mask off Command status
   RAM_EPILOGUE RAM_USE_CLASS_4
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: CHILD_3_bErrCheck
;
;  DESCRIPTION:
...
_CHILD_3_bErrCheck:
   ...
   RAM_SETPAGE_CUR >CHILD_3_fStatus
   mov A,  [CHILD_3_fStatus]
   and A, CHILD_3_RX_BUF_ERROR                   ; Mask off Error status
   and [CHILD_3_fStatus], ~CHILD_3_RX_BUF_ERROR
   RAM_EPILOGUE RAM_USE_CLASS_4
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: CHILD_3_bCmdLength
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: CHILD_3_szGetParam
;
;  DESCRIPTION:
...
;     CHILD_3_CmdReset which resets the entire buffer to the 'empty'
;     state. Typically this function, CHILD_3_szGetParam, is
;     not called until the buffer has been loaded with an entire command
;     (See CHILD_3_bCmdCheck).
;
...
_CHILD_3_szGetParam:
   ...
   RAM_SETPAGE_CUR >ptrParam
   RAM_SETPAGE_IDX >CHILD_3_aRxBuffer

   mov  A, <CHILD_3_aRxBuffer               ; Get address to receive buffer
...
.CheckForDelim:
    cmp  A,CHILD_3_DELIMITER                ; Check if we have a delimiter
    jnz  .ParamStartFound
    inc  X                                  ; Increment both current pointer and
    inc  [ptrParam]                         ; stored pointer.
    mov  A,[X]                              ; Get character pointed by X
    cmp  [ptrParam],(CHILD_3_RX_BUFFER_SIZE -1)  ; Check if we are at the end of buffer
    jnz  .CheckForDelim
                                            ; End of string found
.EndOfString:
    push X                                  ; Save ptr
...
.ParamLoop:
    ...
    mov  [ptrParam],(CHILD_3_RX_BUFFER_SIZE -1)  ; Reset pointer to end of string.
...
.NotNullString:
   pop  X
   mov  A,>CHILD_3_aRxBuffer                     ; Return pointer
   RAM_EPILOGUE RAM_USE_CLASS_3
   RAM_EPILOGUE RAM_USE_CLASS_4
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: CHILD_3_szGetRestOfParams
;
;  DESCRIPTION:
...
;          CUR_PP
;
 CHILD_3_szGetRestOfParams:
_CHILD_3_szGetRestOfParams:
   RAM_PROLOGUE RAM_USE_CLASS_4
   RAM_SETPAGE_CUR >ptrParam
