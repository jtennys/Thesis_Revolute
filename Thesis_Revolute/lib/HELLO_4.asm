...
;  Global Symbols
;-----------------------------------------------
export   HELLO_4_EnableInt
export  _HELLO_4_EnableInt
export   HELLO_4_DisableInt
export  _HELLO_4_DisableInt
export   HELLO_4_Start
export  _HELLO_4_Start
export   HELLO_4_Stop
export  _HELLO_4_Stop
export   HELLO_4_bReadRxData
export  _HELLO_4_bReadRxData
export   HELLO_4_bReadRxStatus
export  _HELLO_4_bReadRxStatus

; Old function name convension, do not use.
; These will be removed in a future release.
export  bHELLO_4_ReadRxData
export _bHELLO_4_ReadRxData
export  bHELLO_4_ReadRxStatus
export _bHELLO_4_ReadRxStatus

;-----------------------------------------------
; High Level RX functions
;-----------------------------------------------

export  HELLO_4_cGetChar
export _HELLO_4_cGetChar
export  HELLO_4_cReadChar
export _HELLO_4_cReadChar
export  HELLO_4_iReadChar
export _HELLO_4_iReadChar

IF (HELLO_4_RXBUF_ENABLE)
export  HELLO_4_CmdReset
export _HELLO_4_CmdReset
export  HELLO_4_bCmdCheck
export _HELLO_4_bCmdCheck
export  HELLO_4_bCmdLength
export _HELLO_4_bCmdLength
export  HELLO_4_bErrCheck
export _HELLO_4_bErrCheck

export  HELLO_4_szGetParam
export _HELLO_4_szGetParam
export  HELLO_4_szGetRestOfParams
export _HELLO_4_szGetRestOfParams

;-----------------------------------------------
;  Variables
;-----------------------------------------------

AREA HELLO_4_RAM(RAM,REL,CON)
 ptrParam:   			BLK  1
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: HELLO_4_EnableInt
;
;  DESCRIPTION:
...
_HELLO_4_EnableInt:
   ...
   M8C_EnableIntMask HELLO_4_INT_REG, HELLO_4_bINT_MASK
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: HELLO_4_DisableInt
;
;  DESCRIPTION:
...
_HELLO_4_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   M8C_DisableIntMask HELLO_4_INT_REG, HELLO_4_bINT_MASK
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: HELLO_4_Start(BYTE bParity)
;
;  DESCRIPTION:
...
_HELLO_4_Stop:
   RAM_PROLOGUE RAM_USE_CLASS_1
   and   REG[HELLO_4_CONTROL_REG], ~bfCONTROL_REG_START_BIT
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: HELLO_4_bReadRxData
;
;  DESCRIPTION:
...
;
 HELLO_4_bReadRxData:
_HELLO_4_bReadRxData:
 bHELLO_4_ReadRxData:
_bHELLO_4_ReadRxData:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov A, REG[HELLO_4_RX_BUFFER_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: HELLO_4_bReadRxStatus
;
;  DESCRIPTION:
...
;    functions.
;
 HELLO_4_bReadRxStatus:
_HELLO_4_bReadRxStatus:
 bHELLO_4_ReadRxStatus:
_bHELLO_4_ReadRxStatus:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov A,  REG[HELLO_4_CONTROL_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: HELLO_4_cGetChar
;
;  DESCRIPTION:
...
.getChar_Loop:
   tst REG[HELLO_4_CONTROL_REG],HELLO_4_RX_REG_FULL   ; Check if a character is ready
   jz  .getChar_Loop                                        ; If not loop

   mov A, REG[HELLO_4_RX_BUFFER_REG]             ; Get character
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: HELLO_4_cReadChar
;
;  DESCRIPTION:
;     Read character from UART RX port.
;
...
_HELLO_4_cReadChar:
   ...
   mov  A,REG[HELLO_4_CONTROL_REG]                         ; Get Status of RX
   push A
   and  A,HELLO_4_RX_COMPLETE                              ; Check if a character is ready
   jnz  .RX_DATA_RDY                                       ; Data Ready go read it.
   pop  A
   jmp  .RX_NO_VALID_CHAR

.RX_DATA_RDY:
   mov  A,REG[HELLO_4_RX_BUFFER_REG]                       ; Read data first, then
   swap A,X                                                ; determine if data is valid

   pop  A                                                  ; Check for errors
   and  A,(HELLO_4_RX_PARITY_ERROR | HELLO_4_RX_FRAMING_ERROR)
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: HELLO_4_iReadChar
;
...
_HELLO_4_iReadChar:
   ...
   and  A,(HELLO_4_RX_ERROR|HELLO_4_RX_REG_FULL)
   push A
   and  A,HELLO_4_RX_COMPLETE                              ; Check if a character is ready
   jnz  .RX_GET_DATA                                       ; Data Ready go read it.
   pop  A
   or   A,HELLO_4_RX_NO_DATA                               ; Add no data flag
   swap A,X
   jmp  End_HELLO_4_iReadChar

.RX_GET_DATA:
   pop  A
   and  A,HELLO_4_RX_ERROR
   swap A,X
   mov  A,REG[HELLO_4_RX_BUFFER_REG]                       ; Read data first, then
                                                           ; determine if data is valid

 End_HELLO_4_iReadChar:
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
;-----------------------------------------------------------------------------
;  FUNCTION NAME: HELLO_4_CmdReset
;
;  DESCRIPTION:
...
_HELLO_4_CmdReset:
   ...
   RAM_SETPAGE_CUR >HELLO_4_aRxBuffer
   mov [HELLO_4_aRxBuffer], 0x00
   RAM_SETPAGE_CUR >ptrParam
   mov [ptrParam],0x00
   RAM_SETPAGE_CUR >HELLO_4_bRxCnt
   mov [HELLO_4_bRxCnt], 0x00
   and [HELLO_4_fStatus], 0x00
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: HELLO_4_bCmdCheck
;
;  DESCRIPTION:
...
_HELLO_4_bCmdCheck:
   RAM_PROLOGUE RAM_USE_CLASS_4
   RAM_SETPAGE_CUR >HELLO_4_fStatus
   mov A,  [HELLO_4_fStatus]
   and A, HELLO_4_RX_BUF_CMDTERM                 ; Mask off Command status
   RAM_EPILOGUE RAM_USE_CLASS_4
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: HELLO_4_bErrCheck
;
;  DESCRIPTION:
...
_HELLO_4_bErrCheck:
   ...
   RAM_SETPAGE_CUR >HELLO_4_fStatus
   mov A,  [HELLO_4_fStatus]
   and A, HELLO_4_RX_BUF_ERROR                   ; Mask off Error status
   and [HELLO_4_fStatus], ~HELLO_4_RX_BUF_ERROR
   RAM_EPILOGUE RAM_USE_CLASS_4
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: HELLO_4_bCmdLength
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: HELLO_4_szGetParam
;
;  DESCRIPTION:
...
;     HELLO_4_CmdReset which resets the entire buffer to the 'empty'
;     state. Typically this function, HELLO_4_szGetParam, is
;     not called until the buffer has been loaded with an entire command
;     (See HELLO_4_bCmdCheck).
;
...
_HELLO_4_szGetParam:
   ...
   RAM_SETPAGE_CUR >ptrParam
   RAM_SETPAGE_IDX >HELLO_4_aRxBuffer

   mov  A, <HELLO_4_aRxBuffer               ; Get address to receive buffer
...
.CheckForDelim:
    cmp  A,HELLO_4_DELIMITER                ; Check if we have a delimiter
    jnz  .ParamStartFound
    inc  X                                  ; Increment both current pointer and
    inc  [ptrParam]                         ; stored pointer.
    mov  A,[X]                              ; Get character pointed by X
    cmp  [ptrParam],(HELLO_4_RX_BUFFER_SIZE -1)  ; Check if we are at the end of buffer
    jnz  .CheckForDelim
                                            ; End of string found
.EndOfString:
    push X                                  ; Save ptr
...
.ParamLoop:
    ...
    mov  [ptrParam],(HELLO_4_RX_BUFFER_SIZE -1)  ; Reset pointer to end of string.
...
.NotNullString:
   pop  X
   mov  A,>HELLO_4_aRxBuffer                     ; Return pointer
   RAM_EPILOGUE RAM_USE_CLASS_3
   RAM_EPILOGUE RAM_USE_CLASS_4
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: HELLO_4_szGetRestOfParams
;
;  DESCRIPTION:
...
;          CUR_PP
;
 HELLO_4_szGetRestOfParams:
_HELLO_4_szGetRestOfParams:
   RAM_PROLOGUE RAM_USE_CLASS_4
   RAM_SETPAGE_CUR >ptrParam
