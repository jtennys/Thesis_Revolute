...
;  Global Symbols
;-----------------------------------------------
export   CHILD_4_EnableInt
export  _CHILD_4_EnableInt
export   CHILD_4_DisableInt
export  _CHILD_4_DisableInt
export   CHILD_4_Start
export  _CHILD_4_Start
export   CHILD_4_Stop
export  _CHILD_4_Stop
export   CHILD_4_bReadRxData
export  _CHILD_4_bReadRxData
export   CHILD_4_bReadRxStatus
export  _CHILD_4_bReadRxStatus

; Old function name convension, do not use.
; These will be removed in a future release.
export  bCHILD_4_ReadRxData
export _bCHILD_4_ReadRxData
export  bCHILD_4_ReadRxStatus
export _bCHILD_4_ReadRxStatus

;-----------------------------------------------
; High Level RX functions
;-----------------------------------------------

export  CHILD_4_cGetChar
export _CHILD_4_cGetChar
export  CHILD_4_cReadChar
export _CHILD_4_cReadChar
export  CHILD_4_iReadChar
export _CHILD_4_iReadChar

IF (CHILD_4_RXBUF_ENABLE)
export  CHILD_4_CmdReset
export _CHILD_4_CmdReset
export  CHILD_4_bCmdCheck
export _CHILD_4_bCmdCheck
export  CHILD_4_bCmdLength
export _CHILD_4_bCmdLength
export  CHILD_4_bErrCheck
export _CHILD_4_bErrCheck

export  CHILD_4_szGetParam
export _CHILD_4_szGetParam
export  CHILD_4_szGetRestOfParams
export _CHILD_4_szGetRestOfParams

;-----------------------------------------------
;  Variables
;-----------------------------------------------

AREA CHILD_4_RAM(RAM,REL,CON)
 ptrParam:   			BLK  1
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: CHILD_4_EnableInt
;
;  DESCRIPTION:
...
_CHILD_4_EnableInt:
   ...
   M8C_EnableIntMask CHILD_4_INT_REG, CHILD_4_bINT_MASK
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: CHILD_4_DisableInt
;
;  DESCRIPTION:
...
_CHILD_4_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   M8C_DisableIntMask CHILD_4_INT_REG, CHILD_4_bINT_MASK
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: CHILD_4_Start(BYTE bParity)
;
;  DESCRIPTION:
...
_CHILD_4_Stop:
   RAM_PROLOGUE RAM_USE_CLASS_1
   and   REG[CHILD_4_CONTROL_REG], ~bfCONTROL_REG_START_BIT
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: CHILD_4_bReadRxData
;
;  DESCRIPTION:
...
;
 CHILD_4_bReadRxData:
_CHILD_4_bReadRxData:
 bCHILD_4_ReadRxData:
_bCHILD_4_ReadRxData:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov A, REG[CHILD_4_RX_BUFFER_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: CHILD_4_bReadRxStatus
;
;  DESCRIPTION:
...
;    functions.
;
 CHILD_4_bReadRxStatus:
_CHILD_4_bReadRxStatus:
 bCHILD_4_ReadRxStatus:
_bCHILD_4_ReadRxStatus:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov A,  REG[CHILD_4_CONTROL_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: CHILD_4_cGetChar
;
;  DESCRIPTION:
...
.getChar_Loop:
   tst REG[CHILD_4_CONTROL_REG],CHILD_4_RX_REG_FULL   ; Check if a character is ready
   jz  .getChar_Loop                                        ; If not loop

   mov A, REG[CHILD_4_RX_BUFFER_REG]             ; Get character
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: CHILD_4_cReadChar
;
;  DESCRIPTION:
;     Read character from UART RX port.
;
...
_CHILD_4_cReadChar:
   ...
   mov  A,REG[CHILD_4_CONTROL_REG]                         ; Get Status of RX
   push A
   and  A,CHILD_4_RX_COMPLETE                              ; Check if a character is ready
   jnz  .RX_DATA_RDY                                       ; Data Ready go read it.
   pop  A
   jmp  .RX_NO_VALID_CHAR

.RX_DATA_RDY:
   mov  A,REG[CHILD_4_RX_BUFFER_REG]                       ; Read data first, then
   swap A,X                                                ; determine if data is valid

   pop  A                                                  ; Check for errors
   and  A,(CHILD_4_RX_PARITY_ERROR | CHILD_4_RX_FRAMING_ERROR)
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: CHILD_4_iReadChar
;
...
_CHILD_4_iReadChar:
   ...
   and  A,(CHILD_4_RX_ERROR|CHILD_4_RX_REG_FULL)
   push A
   and  A,CHILD_4_RX_COMPLETE                              ; Check if a character is ready
   jnz  .RX_GET_DATA                                       ; Data Ready go read it.
   pop  A
   or   A,CHILD_4_RX_NO_DATA                               ; Add no data flag
   swap A,X
   jmp  End_CHILD_4_iReadChar

.RX_GET_DATA:
   pop  A
   and  A,CHILD_4_RX_ERROR
   swap A,X
   mov  A,REG[CHILD_4_RX_BUFFER_REG]                       ; Read data first, then
                                                           ; determine if data is valid

 End_CHILD_4_iReadChar:
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
;-----------------------------------------------------------------------------
;  FUNCTION NAME: CHILD_4_CmdReset
;
;  DESCRIPTION:
...
_CHILD_4_CmdReset:
   ...
   RAM_SETPAGE_CUR >CHILD_4_aRxBuffer
   mov [CHILD_4_aRxBuffer], 0x00
   RAM_SETPAGE_CUR >ptrParam
   mov [ptrParam],0x00
   RAM_SETPAGE_CUR >CHILD_4_bRxCnt
   mov [CHILD_4_bRxCnt], 0x00
   and [CHILD_4_fStatus], 0x00
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: CHILD_4_bCmdCheck
;
;  DESCRIPTION:
...
_CHILD_4_bCmdCheck:
   RAM_PROLOGUE RAM_USE_CLASS_4
   RAM_SETPAGE_CUR >CHILD_4_fStatus
   mov A,  [CHILD_4_fStatus]
   and A, CHILD_4_RX_BUF_CMDTERM                 ; Mask off Command status
   RAM_EPILOGUE RAM_USE_CLASS_4
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: CHILD_4_bErrCheck
;
;  DESCRIPTION:
...
_CHILD_4_bErrCheck:
   ...
   RAM_SETPAGE_CUR >CHILD_4_fStatus
   mov A,  [CHILD_4_fStatus]
   and A, CHILD_4_RX_BUF_ERROR                   ; Mask off Error status
   and [CHILD_4_fStatus], ~CHILD_4_RX_BUF_ERROR
   RAM_EPILOGUE RAM_USE_CLASS_4
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: CHILD_4_bCmdLength
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: CHILD_4_szGetParam
;
;  DESCRIPTION:
...
;     CHILD_4_CmdReset which resets the entire buffer to the 'empty'
;     state. Typically this function, CHILD_4_szGetParam, is
;     not called until the buffer has been loaded with an entire command
;     (See CHILD_4_bCmdCheck).
;
...
_CHILD_4_szGetParam:
   ...
   RAM_SETPAGE_CUR >ptrParam
   RAM_SETPAGE_IDX >CHILD_4_aRxBuffer

   mov  A, <CHILD_4_aRxBuffer               ; Get address to receive buffer
...
.CheckForDelim:
    cmp  A,CHILD_4_DELIMITER                ; Check if we have a delimiter
    jnz  .ParamStartFound
    inc  X                                  ; Increment both current pointer and
    inc  [ptrParam]                         ; stored pointer.
    mov  A,[X]                              ; Get character pointed by X
    cmp  [ptrParam],(CHILD_4_RX_BUFFER_SIZE -1)  ; Check if we are at the end of buffer
    jnz  .CheckForDelim
                                            ; End of string found
.EndOfString:
    push X                                  ; Save ptr
...
.ParamLoop:
    ...
    mov  [ptrParam],(CHILD_4_RX_BUFFER_SIZE -1)  ; Reset pointer to end of string.
...
.NotNullString:
   pop  X
   mov  A,>CHILD_4_aRxBuffer                     ; Return pointer
   RAM_EPILOGUE RAM_USE_CLASS_3
   RAM_EPILOGUE RAM_USE_CLASS_4
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: CHILD_4_szGetRestOfParams
;
;  DESCRIPTION:
...
;          CUR_PP
;
 CHILD_4_szGetRestOfParams:
_CHILD_4_szGetRestOfParams:
   RAM_PROLOGUE RAM_USE_CLASS_4
   RAM_SETPAGE_CUR >ptrParam
