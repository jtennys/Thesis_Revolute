...
;  Global Symbols
;-----------------------------------------------
export   TX_23_SetTxIntMode
export  _TX_23_SetTxIntMode
export   TX_23_EnableInt
export  _TX_23_EnableInt
export   TX_23_DisableInt
export  _TX_23_DisableInt
export   TX_23_Start
export  _TX_23_Start
export   TX_23_Stop
export  _TX_23_Stop
export   TX_23_SendData
export  _TX_23_SendData
export   TX_23_bReadTxStatus
export  _TX_23_bReadTxStatus

// Old labels, will be removed in future release
// Do Not Use.
export   bTX_23_ReadTxStatus
export  _bTX_23_ReadTxStatus

;-----------------------------------------------
;  High Level TX functions
;-----------------------------------------------
export  TX_23_PutSHexByte
export _TX_23_PutSHexByte
export  TX_23_PutSHexInt
export _TX_23_PutSHexInt

export  TX_23_CPutString
export _TX_23_CPutString
export  TX_23_PutString
export _TX_23_PutString
export  TX_23_PutChar
export _TX_23_PutChar
export  TX_23_Write
export _TX_23_Write
export  TX_23_CWrite
export _TX_23_CWrite
export  TX_23_PutCRLF
export _TX_23_PutCRLF 
...
_TX_23_EnableInt:
   ...
   M8C_EnableIntMask  TX_23_INT_REG, TX_23_bINT_MASK
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TX_23_DisableInt
;
;  DESCRIPTION:
...
_TX_23_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   M8C_DisableIntMask TX_23_INT_REG, TX_23_bINT_MASK
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TX_23_SetTxIntMode(BYTE bTxIntMode)
;
;  DESCRIPTION:
...
_TX_23_SetTxIntMode:
   RAM_PROLOGUE RAM_USE_CLASS_1
   M8C_SetBank1
   and   A, TX_23_INT_MODE_TX_COMPLETE
   jz    .SetModeRegEmpty
   or    REG[TX_23_FUNC_REG], bfFUNCTION_REG_TX_INT_MODE_BIT
   M8C_SetBank0
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret

.SetModeRegEmpty:
   and   REG[TX_23_FUNC_REG], ~bfFUNCTION_REG_TX_INT_MODE_BIT
   M8C_SetBank0
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TX_23_Start(BYTE bParity)
;
;  DESCRIPTION:
...
_TX_23_Stop:
   RAM_PROLOGUE RAM_USE_CLASS_1
   and   REG[TX_23_CONTROL_REG], ~bfCONTROL_REG_START_BIT
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TX_23_bReadTxStatus
;
;  DESCRIPTION:
...
;
 TX_23_bReadTxStatus:
_TX_23_bReadTxStatus:
 bTX_23_ReadTxStatus:
_bTX_23_ReadTxStatus:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov A,  REG[TX_23_CONTROL_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TX_23_PutSHexByte
;
;  DESCRIPTION:
...
_TX_23_PutSHexByte:
    ...
    index TX_23_HEX_STR                ; Get Hex value
    call  TX_23_PutChar                ; Write data to screen
    pop   A                            ; Restore value
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TX_23_PutSHexInt
;
;  DESCRIPTION:
...
_TX_23_PutSHexInt:
    RAM_PROLOGUE RAM_USE_CLASS_1
    swap  A,X
    call  TX_23_PutSHexByte            ; Print MSB
    mov   A,X                          ; Move LSB into position
    call  TX_23_PutSHexByte            ; Print LSB
    RAM_EPILOGUE RAM_USE_CLASS_1
    ret
.ENDSECTION
...
.BufEmptyWaitLoop:
   tst REG[TX_23_CONTROL_REG], TX_23_TX_BUFFER_EMPTY    ; Check Tx Status
   jz  .BufEmptyWaitLoop
   mov REG[TX_23_TX_BUFFER_REG], @Source    ; Write data to Tx Port
   endm
...
.PutStringLoop:
   ...
   call  TX_23_PutChar                      ; Send character to Tx port
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TX_23_CPutString
;
;  DESCRIPTION:
;     Send String out through UART TX port.
;
...
_TX_23_CPutString:
   ...
   romx                                          ; Get character from ROM
   jz    .End_CPutString
   call  TX_23_PutChar                      ; Print character
   pop   X
   pop   A
   inc   X                                       ; Inc LSB of pointer
   jnc   TX_23_CPutString                        ; Check for carry
   inc   A                                       ; Inc MSB of pointer
   jmp   TX_23_CPutString
