...
;  Global Symbols
;-----------------------------------------------
export   HELLO_3_EnableInt
export  _HELLO_3_EnableInt
export   HELLO_3_DisableInt
export  _HELLO_3_DisableInt
export   HELLO_3_Start
export  _HELLO_3_Start
export   HELLO_3_Stop
export  _HELLO_3_Stop
export   HELLO_3_bReadRxData
export  _HELLO_3_bReadRxData
export   HELLO_3_bReadRxStatus
export  _HELLO_3_bReadRxStatus

; Old function name convension, do not use.
; These will be removed in a future release.
export  bHELLO_3_ReadRxData
export _bHELLO_3_ReadRxData
export  bHELLO_3_ReadRxStatus
export _bHELLO_3_ReadRxStatus

;-----------------------------------------------
; High Level RX functions
;-----------------------------------------------

export  HELLO_3_cGetChar
export _HELLO_3_cGetChar
export  HELLO_3_cReadChar
export _HELLO_3_cReadChar
export  HELLO_3_iReadChar
export _HELLO_3_iReadChar

IF (HELLO_3_RXBUF_ENABLE)
export  HELLO_3_CmdReset
export _HELLO_3_CmdReset
export  HELLO_3_bCmdCheck
export _HELLO_3_bCmdCheck
export  HELLO_3_bCmdLength
export _HELLO_3_bCmdLength
export  HELLO_3_bErrCheck
export _HELLO_3_bErrCheck

export  HELLO_3_szGetParam
export _HELLO_3_szGetParam
export  HELLO_3_szGetRestOfParams
export _HELLO_3_szGetRestOfParams
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: HELLO_3_EnableInt
;
;  DESCRIPTION:
...
_HELLO_3_EnableInt:
   ...
   M8C_EnableIntMask HELLO_3_INT_REG, HELLO_3_bINT_MASK
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: HELLO_3_DisableInt
;
;  DESCRIPTION:
...
_HELLO_3_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   M8C_DisableIntMask HELLO_3_INT_REG, HELLO_3_bINT_MASK
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: HELLO_3_Start(BYTE bParity)
;
;  DESCRIPTION:
...
_HELLO_3_Stop:
   RAM_PROLOGUE RAM_USE_CLASS_1
   and   REG[HELLO_3_CONTROL_REG], ~bfCONTROL_REG_START_BIT
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: HELLO_3_bReadRxData
;
;  DESCRIPTION:
...
;
 HELLO_3_bReadRxData:
_HELLO_3_bReadRxData:
 bHELLO_3_ReadRxData:
_bHELLO_3_ReadRxData:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov A, REG[HELLO_3_RX_BUFFER_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: HELLO_3_bReadRxStatus
;
;  DESCRIPTION:
...
;    functions.
;
 HELLO_3_bReadRxStatus:
_HELLO_3_bReadRxStatus:
 bHELLO_3_ReadRxStatus:
_bHELLO_3_ReadRxStatus:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov A,  REG[HELLO_3_CONTROL_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: HELLO_3_cGetChar
;
;  DESCRIPTION:
...
.getChar_Loop:
   tst REG[HELLO_3_CONTROL_REG],HELLO_3_RX_REG_FULL   ; Check if a character is ready
   jz  .getChar_Loop                                        ; If not loop

   mov A, REG[HELLO_3_RX_BUFFER_REG]             ; Get character
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: HELLO_3_cReadChar
;
;  DESCRIPTION:
;     Read character from UART RX port.
;
...
_HELLO_3_cReadChar:
   ...
   mov  A,REG[HELLO_3_CONTROL_REG]                         ; Get Status of RX
   push A
   and  A,HELLO_3_RX_COMPLETE                              ; Check if a character is ready
   jnz  .RX_DATA_RDY                                       ; Data Ready go read it.
   pop  A
   jmp  .RX_NO_VALID_CHAR

.RX_DATA_RDY:
   mov  A,REG[HELLO_3_RX_BUFFER_REG]                       ; Read data first, then
   swap A,X                                                ; determine if data is valid

   pop  A                                                  ; Check for errors
   and  A,(HELLO_3_RX_PARITY_ERROR | HELLO_3_RX_FRAMING_ERROR)
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: HELLO_3_iReadChar
;
...
_HELLO_3_iReadChar:
   ...
   and  A,(HELLO_3_RX_ERROR|HELLO_3_RX_REG_FULL)
   push A
   and  A,HELLO_3_RX_COMPLETE                              ; Check if a character is ready
   jnz  .RX_GET_DATA                                       ; Data Ready go read it.
   pop  A
   or   A,HELLO_3_RX_NO_DATA                               ; Add no data flag
   swap A,X
   jmp  End_HELLO_3_iReadChar
...
;-----------------------------------------------------------------------------
;  FUNCTION NAME: HELLO_3_CmdReset
;
;  DESCRIPTION:
...
_HELLO_3_CmdReset:
   ...
   RAM_SETPAGE_CUR >HELLO_3_aRxBuffer
   mov [HELLO_3_aRxBuffer], 0x00
   RAM_SETPAGE_CUR >ptrParam
   mov [ptrParam],0x00
   RAM_SETPAGE_CUR >HELLO_3_bRxCnt
   mov [HELLO_3_bRxCnt], 0x00
   and [HELLO_3_fStatus], 0x00
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: HELLO_3_bCmdCheck
;
;  DESCRIPTION:
...
_HELLO_3_bCmdCheck:
   RAM_PROLOGUE RAM_USE_CLASS_4
   RAM_SETPAGE_CUR >HELLO_3_fStatus
   mov A,  [HELLO_3_fStatus]
   and A, HELLO_3_RX_BUF_CMDTERM                 ; Mask off Command status
   RAM_EPILOGUE RAM_USE_CLASS_4
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: HELLO_3_bErrCheck
;
;  DESCRIPTION:
...
_HELLO_3_bErrCheck:
   ...
   RAM_SETPAGE_CUR >HELLO_3_fStatus
   mov A,  [HELLO_3_fStatus]
   and A, HELLO_3_RX_BUF_ERROR                   ; Mask off Error status
   and [HELLO_3_fStatus], ~HELLO_3_RX_BUF_ERROR
   RAM_EPILOGUE RAM_USE_CLASS_4
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: HELLO_3_bCmdLength
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: HELLO_3_szGetParam
;
;  DESCRIPTION:
...
;     HELLO_3_CmdReset which resets the entire buffer to the 'empty'
;     state. Typically this function, HELLO_3_szGetParam, is
;     not called until the buffer has been loaded with an entire command
;     (See HELLO_3_bCmdCheck).
;
...
_HELLO_3_szGetParam:
   ...
   mov  A, <HELLO_3_aRxBuffer               ; Get address to receive buffer
...
.CheckForDelim:
    cmp  A,HELLO_3_DELIMITER                ; Check if we have a delimiter
    jnz  .ParamStartFound
    inc  X                                  ; Increment both current pointer and
    inc  [ptrParam]                         ; stored pointer.
    mov  A,[X]                              ; Get character pointed by X
    cmp  [ptrParam],(HELLO_3_RX_BUFFER_SIZE -1)  ; Check if we are at the end of buffer
    jnz  .CheckForDelim
                                            ; End of string found
.EndOfString:
    push X                                  ; Save ptr
...
.ParamLoop:
    ...
    mov  [ptrParam],(HELLO_3_RX_BUFFER_SIZE -1)  ; Reset pointer to end of string.
...
.NotNullString:
   pop  X
   mov  A,>HELLO_3_aRxBuffer                     ; Return pointer
   RAM_EPILOGUE RAM_USE_CLASS_3
   RAM_EPILOGUE RAM_USE_CLASS_4
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: HELLO_3_szGetRestOfParams
;
;  DESCRIPTION:
...
;          CUR_PP
;
 HELLO_3_szGetRestOfParams:
_HELLO_3_szGetRestOfParams:
   RAM_PROLOGUE RAM_USE_CLASS_4
   RAM_SETPAGE_CUR >ptrParam
