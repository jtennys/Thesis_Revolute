...
export  TX_01234_TIMEOUT_wReadCompareValue
export _TX_01234_TIMEOUT_wReadCompareValue
export  TX_01234_TIMEOUT_wReadTimer
export _TX_01234_TIMEOUT_wReadTimer
export  TX_01234_TIMEOUT_wReadTimerSaveCV
export _TX_01234_TIMEOUT_wReadTimerSaveCV

; The following functions are deprecated and subject to omission in future releases
;
export  wTX_01234_TIMEOUT_ReadCompareValue  ; deprecated
export _wTX_01234_TIMEOUT_ReadCompareValue  ; deprecated
export  wTX_01234_TIMEOUT_ReadTimer         ; deprecated
export _wTX_01234_TIMEOUT_ReadTimer         ; deprecated
export  wTX_01234_TIMEOUT_ReadTimerSaveCV   ; deprecated
export _wTX_01234_TIMEOUT_ReadTimerSaveCV   ; deprecated

export  wTX_01234_TIMEOUT_ReadCounter       ; obsolete
export _wTX_01234_TIMEOUT_ReadCounter       ; obsolete
export  wTX_01234_TIMEOUT_CaptureCounter    ; obsolete
export _wTX_01234_TIMEOUT_CaptureCounter    ; obsolete
...
_TX_01234_TIMEOUT_WritePeriod:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[TX_01234_TIMEOUT_PERIOD_LSB_REG], A
   mov   A, X
   mov   reg[TX_01234_TIMEOUT_PERIOD_MSB_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
_TX_01234_TIMEOUT_WriteCompareValue:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[TX_01234_TIMEOUT_COMPARE_LSB_REG], A
   mov   A, X
   mov   reg[TX_01234_TIMEOUT_COMPARE_MSB_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TX_01234_TIMEOUT_wReadCompareValue
;
;  DESCRIPTION:
...
;    functions.
;
 TX_01234_TIMEOUT_wReadCompareValue:
_TX_01234_TIMEOUT_wReadCompareValue:
 wTX_01234_TIMEOUT_ReadCompareValue:                ; this name deprecated
_wTX_01234_TIMEOUT_ReadCompareValue:                ; this name deprecated
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[TX_01234_TIMEOUT_COMPARE_MSB_REG]
   mov   X, A
   mov   A, reg[TX_01234_TIMEOUT_COMPARE_LSB_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TX_01234_TIMEOUT_wReadTimerSaveCV
;
;  DESCRIPTION:
...
;
 TX_01234_TIMEOUT_wReadTimerSaveCV:
_TX_01234_TIMEOUT_wReadTimerSaveCV:
 wTX_01234_TIMEOUT_ReadTimerSaveCV:                ; this name deprecated
_wTX_01234_TIMEOUT_ReadTimerSaveCV:                ; this name deprecated
 wTX_01234_TIMEOUT_ReadCounter:                    ; this name deprecated
_wTX_01234_TIMEOUT_ReadCounter:                    ; this name deprecated
...
wCount_LSB:    equ   2
   ...
   mov   A, reg[TX_01234_TIMEOUT_CONTROL_LSB_REG]; save the Control register
   push  A
   mov   A, reg[TX_01234_TIMEOUT_COMPARE_LSB_REG]; save the Compare register
   push  A
   mov   A, reg[TX_01234_TIMEOUT_COMPARE_MSB_REG]
   push  A
   mov   A, reg[TX_01234_TIMEOUT_COUNTER_LSB_REG]; synchronous copy DR2 <- DR0
                                                 ; This may cause an interrupt!
   mov   A, reg[TX_01234_TIMEOUT_COMPARE_MSB_REG]; Now grab DR2 (DR0) and save
   mov   [X+wCount_MSB], A
   mov   A, reg[TX_01234_TIMEOUT_COMPARE_LSB_REG]
   mov   [X+wCount_LSB], A
...
.SetupStatusFlag:                                ; and ...
   ...
   TX_01234_TIMEOUT_Stop_M                       ; Disable (stop) the timer
   pop   A                                       ; Restore the Compare register
   mov   reg[TX_01234_TIMEOUT_COMPARE_MSB_REG], A
   pop   A
   mov   reg[TX_01234_TIMEOUT_COMPARE_LSB_REG], A
   pop   A                                       ; restore start state of the timer
   mov   reg[TX_01234_TIMEOUT_CONTROL_LSB_REG], A
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TX_01234_TIMEOUT_wReadTimer
;
;  DESCRIPTION:
...
;
 TX_01234_TIMEOUT_wReadTimer:
_TX_01234_TIMEOUT_wReadTimer:
 wTX_01234_TIMEOUT_ReadTimer:                    ; this name deprecated
_wTX_01234_TIMEOUT_ReadTimer:                    ; this name deprecated
 wTX_01234_TIMEOUT_CaptureCounter:               ; this name deprecated
_wTX_01234_TIMEOUT_CaptureCounter:               ; this name deprecated

   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[TX_01234_TIMEOUT_COUNTER_LSB_REG]; synchronous copy DR2 <- DR0
                                                 ; This may cause an interrupt!

   mov   A, reg[TX_01234_TIMEOUT_COMPARE_MSB_REG]; Return DR2 (actually DR0)
   mov   X, A
   mov   A, reg[TX_01234_TIMEOUT_COMPARE_LSB_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
