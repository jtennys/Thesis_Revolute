...
;  Global Symbols
;-----------------------------------------------
export   HELLO_1_EnableInt
export  _HELLO_1_EnableInt
export   HELLO_1_DisableInt
export  _HELLO_1_DisableInt
export   HELLO_1_Start
export  _HELLO_1_Start
export   HELLO_1_Stop
export  _HELLO_1_Stop
export   HELLO_1_bReadRxData
export  _HELLO_1_bReadRxData
export   HELLO_1_bReadRxStatus
export  _HELLO_1_bReadRxStatus

; Old function name convension, do not use.
; These will be removed in a future release.
export  bHELLO_1_ReadRxData
export _bHELLO_1_ReadRxData
export  bHELLO_1_ReadRxStatus
export _bHELLO_1_ReadRxStatus

;-----------------------------------------------
; High Level RX functions
;-----------------------------------------------

export  HELLO_1_cGetChar
export _HELLO_1_cGetChar
export  HELLO_1_cReadChar
export _HELLO_1_cReadChar
export  HELLO_1_iReadChar
export _HELLO_1_iReadChar

IF (HELLO_1_RXBUF_ENABLE)
export  HELLO_1_CmdReset
export _HELLO_1_CmdReset
export  HELLO_1_bCmdCheck
export _HELLO_1_bCmdCheck
export  HELLO_1_bCmdLength
export _HELLO_1_bCmdLength
export  HELLO_1_bErrCheck
export _HELLO_1_bErrCheck

export  HELLO_1_szGetParam
export _HELLO_1_szGetParam
export  HELLO_1_szGetRestOfParams
export _HELLO_1_szGetRestOfParams
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: HELLO_1_EnableInt
;
;  DESCRIPTION:
...
_HELLO_1_EnableInt:
   ...
   M8C_EnableIntMask HELLO_1_INT_REG, HELLO_1_bINT_MASK
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: HELLO_1_DisableInt
;
;  DESCRIPTION:
...
_HELLO_1_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   M8C_DisableIntMask HELLO_1_INT_REG, HELLO_1_bINT_MASK
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: HELLO_1_Start(BYTE bParity)
;
;  DESCRIPTION:
...
_HELLO_1_Stop:
   RAM_PROLOGUE RAM_USE_CLASS_1
   and   REG[HELLO_1_CONTROL_REG], ~bfCONTROL_REG_START_BIT
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: HELLO_1_bReadRxData
;
;  DESCRIPTION:
...
;
 HELLO_1_bReadRxData:
_HELLO_1_bReadRxData:
 bHELLO_1_ReadRxData:
_bHELLO_1_ReadRxData:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov A, REG[HELLO_1_RX_BUFFER_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: HELLO_1_bReadRxStatus
;
;  DESCRIPTION:
...
;    functions.
;
 HELLO_1_bReadRxStatus:
_HELLO_1_bReadRxStatus:
 bHELLO_1_ReadRxStatus:
_bHELLO_1_ReadRxStatus:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov A,  REG[HELLO_1_CONTROL_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: HELLO_1_cGetChar
;
;  DESCRIPTION:
...
.getChar_Loop:
   tst REG[HELLO_1_CONTROL_REG],HELLO_1_RX_REG_FULL   ; Check if a character is ready
   jz  .getChar_Loop                                        ; If not loop

   mov A, REG[HELLO_1_RX_BUFFER_REG]             ; Get character
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: HELLO_1_cReadChar
;
;  DESCRIPTION:
;     Read character from UART RX port.
;
...
_HELLO_1_cReadChar:
   ...
   mov  A,REG[HELLO_1_CONTROL_REG]                         ; Get Status of RX
   push A
   and  A,HELLO_1_RX_COMPLETE                              ; Check if a character is ready
   jnz  .RX_DATA_RDY                                       ; Data Ready go read it.
   pop  A
   jmp  .RX_NO_VALID_CHAR

.RX_DATA_RDY:
   mov  A,REG[HELLO_1_RX_BUFFER_REG]                       ; Read data first, then
   swap A,X                                                ; determine if data is valid

   pop  A                                                  ; Check for errors
   and  A,(HELLO_1_RX_PARITY_ERROR | HELLO_1_RX_FRAMING_ERROR)
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: HELLO_1_iReadChar
;
...
_HELLO_1_iReadChar:
   ...
   and  A,(HELLO_1_RX_ERROR|HELLO_1_RX_REG_FULL)
   push A
   and  A,HELLO_1_RX_COMPLETE                              ; Check if a character is ready
   jnz  .RX_GET_DATA                                       ; Data Ready go read it.
   pop  A
   or   A,HELLO_1_RX_NO_DATA                               ; Add no data flag
   swap A,X
   jmp  End_HELLO_1_iReadChar
...
;-----------------------------------------------------------------------------
;  FUNCTION NAME: HELLO_1_CmdReset
;
;  DESCRIPTION:
...
_HELLO_1_CmdReset:
   ...
   RAM_SETPAGE_CUR >HELLO_1_aRxBuffer
   mov [HELLO_1_aRxBuffer], 0x00
   RAM_SETPAGE_CUR >ptrParam
   mov [ptrParam],0x00
   RAM_SETPAGE_CUR >HELLO_1_bRxCnt
   mov [HELLO_1_bRxCnt], 0x00
   and [HELLO_1_fStatus], 0x00
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: HELLO_1_bCmdCheck
;
;  DESCRIPTION:
...
_HELLO_1_bCmdCheck:
   RAM_PROLOGUE RAM_USE_CLASS_4
   RAM_SETPAGE_CUR >HELLO_1_fStatus
   mov A,  [HELLO_1_fStatus]
   and A, HELLO_1_RX_BUF_CMDTERM                 ; Mask off Command status
   RAM_EPILOGUE RAM_USE_CLASS_4
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: HELLO_1_bErrCheck
;
;  DESCRIPTION:
...
_HELLO_1_bErrCheck:
   ...
   RAM_SETPAGE_CUR >HELLO_1_fStatus
   mov A,  [HELLO_1_fStatus]
   and A, HELLO_1_RX_BUF_ERROR                   ; Mask off Error status
   and [HELLO_1_fStatus], ~HELLO_1_RX_BUF_ERROR
   RAM_EPILOGUE RAM_USE_CLASS_4
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: HELLO_1_bCmdLength
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: HELLO_1_szGetParam
;
;  DESCRIPTION:
...
;     HELLO_1_CmdReset which resets the entire buffer to the 'empty'
;     state. Typically this function, HELLO_1_szGetParam, is
;     not called until the buffer has been loaded with an entire command
;     (See HELLO_1_bCmdCheck).
;
...
_HELLO_1_szGetParam:
   ...
   mov  A, <HELLO_1_aRxBuffer               ; Get address to receive buffer
...
.CheckForDelim:
    cmp  A,HELLO_1_DELIMITER                ; Check if we have a delimiter
    jnz  .ParamStartFound
    inc  X                                  ; Increment both current pointer and
    inc  [ptrParam]                         ; stored pointer.
    mov  A,[X]                              ; Get character pointed by X
    cmp  [ptrParam],(HELLO_1_RX_BUFFER_SIZE -1)  ; Check if we are at the end of buffer
    jnz  .CheckForDelim
                                            ; End of string found
.EndOfString:
    push X                                  ; Save ptr
...
.ParamLoop:
    ...
    mov  [ptrParam],(HELLO_1_RX_BUFFER_SIZE -1)  ; Reset pointer to end of string.
...
.NotNullString:
   pop  X
   mov  A,>HELLO_1_aRxBuffer                     ; Return pointer
   RAM_EPILOGUE RAM_USE_CLASS_3
   RAM_EPILOGUE RAM_USE_CLASS_4
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: HELLO_1_szGetRestOfParams
;
;  DESCRIPTION:
...
;          CUR_PP
;
 HELLO_1_szGetRestOfParams:
_HELLO_1_szGetRestOfParams:
   RAM_PROLOGUE RAM_USE_CLASS_4
   RAM_SETPAGE_CUR >ptrParam
