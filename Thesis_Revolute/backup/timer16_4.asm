...
include "m8c.inc"
include "memory.inc"
include "Timer16_4.inc"

;-----------------------------------------------
;  Global Symbols
;-----------------------------------------------
export  Timer16_4_EnableInt
export _Timer16_4_EnableInt
export  Timer16_4_DisableInt
export _Timer16_4_DisableInt
export  Timer16_4_Start
export _Timer16_4_Start
export  Timer16_4_Stop
export _Timer16_4_Stop
export  Timer16_4_WritePeriod
export _Timer16_4_WritePeriod
export  Timer16_4_WriteCompareValue
export _Timer16_4_WriteCompareValue
export  Timer16_4_wReadCompareValue
export _Timer16_4_wReadCompareValue
export  Timer16_4_wReadTimer
export _Timer16_4_wReadTimer
export  Timer16_4_wReadTimerSaveCV
export _Timer16_4_wReadTimerSaveCV

; The following functions are deprecated and subject to omission in future releases
;
export  wTimer16_4_ReadCompareValue  ; deprecated
export _wTimer16_4_ReadCompareValue  ; deprecated
export  wTimer16_4_ReadTimer         ; deprecated
export _wTimer16_4_ReadTimer         ; deprecated
export  wTimer16_4_ReadTimerSaveCV   ; deprecated
export _wTimer16_4_ReadTimerSaveCV   ; deprecated

export  wTimer16_4_ReadCounter       ; obsolete
export _wTimer16_4_ReadCounter       ; obsolete
export  wTimer16_4_CaptureCounter    ; obsolete
export _wTimer16_4_CaptureCounter    ; obsolete
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer16_4_EnableInt
;
;  DESCRIPTION:
...
;
 Timer16_4_EnableInt:
_Timer16_4_EnableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   Timer16_4_EnableInt_M
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer16_4_DisableInt
;
;  DESCRIPTION:
...
;    functions.
;
 Timer16_4_DisableInt:
_Timer16_4_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   Timer16_4_DisableInt_M
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer16_4_WritePeriod
;
;  DESCRIPTION:
...
;    functions.
;
 Timer16_4_WritePeriod:
_Timer16_4_WritePeriod:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[Timer16_4_PERIOD_LSB_REG], A
   mov   A, X
   mov   reg[Timer16_4_PERIOD_MSB_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
;    functions.
;
 Timer16_4_WriteCompareValue:
_Timer16_4_WriteCompareValue:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[Timer16_4_COMPARE_LSB_REG], A
   mov   A, X
   mov   reg[Timer16_4_COMPARE_MSB_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer16_4_wReadCompareValue
;
;  DESCRIPTION:
...
;    functions.
;
 Timer16_4_wReadCompareValue:
_Timer16_4_wReadCompareValue:
 wTimer16_4_ReadCompareValue:                    ; this name deprecated
_wTimer16_4_ReadCompareValue:                    ; this name deprecated
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[Timer16_4_COMPARE_MSB_REG]
   mov   X, A
   mov   A, reg[Timer16_4_COMPARE_LSB_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer16_4_wReadTimerSaveCV
;
;  DESCRIPTION:
...
;
 Timer16_4_wReadTimerSaveCV:
_Timer16_4_wReadTimerSaveCV:
 wTimer16_4_ReadTimerSaveCV:                     ; this name deprecated
_wTimer16_4_ReadTimerSaveCV:                     ; this name deprecated
 wTimer16_4_ReadCounter:                         ; this name deprecated
_wTimer16_4_ReadCounter:                         ; this name deprecated
...
wCount_LSB:    equ   2
   ...
   mov   A, reg[Timer16_4_CONTROL_LSB_REG]       ; save the Control register
   push  A
   mov   A, reg[Timer16_4_COMPARE_LSB_REG]       ; save the Compare register
   push  A
   mov   A, reg[Timer16_4_COMPARE_MSB_REG]
   push  A
   mov   A, reg[Timer16_4_COUNTER_LSB_REG]       ; synchronous copy DR2 <- DR0
                                                 ; This may cause an interrupt!
   mov   A, reg[Timer16_4_COMPARE_MSB_REG]       ; Now grab DR2 (DR0) and save
   mov   [X+wCount_MSB], A
   mov   A, reg[Timer16_4_COMPARE_LSB_REG]
   mov   [X+wCount_LSB], A
...
.SetupStatusFlag:                                ; and ...
   ...
   Timer16_4_Stop_M                              ; Disable (stop) the timer
   pop   A                                       ; Restore the Compare register
   mov   reg[Timer16_4_COMPARE_MSB_REG], A
   pop   A
   mov   reg[Timer16_4_COMPARE_LSB_REG], A
   pop   A                                       ; restore start state of the timer
   mov   reg[Timer16_4_CONTROL_LSB_REG], A
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer16_4_wReadTimer
;
;  DESCRIPTION:
...
;
 Timer16_4_wReadTimer:
_Timer16_4_wReadTimer:
 wTimer16_4_ReadTimer:                           ; this name deprecated
_wTimer16_4_ReadTimer:                           ; this name deprecated
 wTimer16_4_CaptureCounter:                      ; this name deprecated
_wTimer16_4_CaptureCounter:                      ; this name deprecated

   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[Timer16_4_COUNTER_LSB_REG]       ; synchronous copy DR2 <- DR0
                                                 ; This may cause an interrupt!

   mov   A, reg[Timer16_4_COMPARE_MSB_REG]       ; Return DR2 (actually DR0)
   mov   X, A
   mov   A, reg[Timer16_4_COMPARE_LSB_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
