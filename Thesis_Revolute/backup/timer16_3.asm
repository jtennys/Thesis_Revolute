...
include "m8c.inc"
include "memory.inc"
include "Timer16_3.inc"

;-----------------------------------------------
;  Global Symbols
;-----------------------------------------------
export  Timer16_3_EnableInt
export _Timer16_3_EnableInt
export  Timer16_3_DisableInt
export _Timer16_3_DisableInt
export  Timer16_3_Start
export _Timer16_3_Start
export  Timer16_3_Stop
export _Timer16_3_Stop
export  Timer16_3_WritePeriod
export _Timer16_3_WritePeriod
export  Timer16_3_WriteCompareValue
export _Timer16_3_WriteCompareValue
export  Timer16_3_wReadCompareValue
export _Timer16_3_wReadCompareValue
export  Timer16_3_wReadTimer
export _Timer16_3_wReadTimer
export  Timer16_3_wReadTimerSaveCV
export _Timer16_3_wReadTimerSaveCV

; The following functions are deprecated and subject to omission in future releases
;
export  wTimer16_3_ReadCompareValue  ; deprecated
export _wTimer16_3_ReadCompareValue  ; deprecated
export  wTimer16_3_ReadTimer         ; deprecated
export _wTimer16_3_ReadTimer         ; deprecated
export  wTimer16_3_ReadTimerSaveCV   ; deprecated
export _wTimer16_3_ReadTimerSaveCV   ; deprecated

export  wTimer16_3_ReadCounter       ; obsolete
export _wTimer16_3_ReadCounter       ; obsolete
export  wTimer16_3_CaptureCounter    ; obsolete
export _wTimer16_3_CaptureCounter    ; obsolete
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer16_3_EnableInt
;
;  DESCRIPTION:
...
;
 Timer16_3_EnableInt:
_Timer16_3_EnableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   Timer16_3_EnableInt_M
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer16_3_DisableInt
;
;  DESCRIPTION:
...
;    functions.
;
 Timer16_3_DisableInt:
_Timer16_3_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   Timer16_3_DisableInt_M
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer16_3_WritePeriod
;
;  DESCRIPTION:
...
;    functions.
;
 Timer16_3_WritePeriod:
_Timer16_3_WritePeriod:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[Timer16_3_PERIOD_LSB_REG], A
   mov   A, X
   mov   reg[Timer16_3_PERIOD_MSB_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
;    functions.
;
 Timer16_3_WriteCompareValue:
_Timer16_3_WriteCompareValue:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[Timer16_3_COMPARE_LSB_REG], A
   mov   A, X
   mov   reg[Timer16_3_COMPARE_MSB_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer16_3_wReadCompareValue
;
;  DESCRIPTION:
...
;    functions.
;
 Timer16_3_wReadCompareValue:
_Timer16_3_wReadCompareValue:
 wTimer16_3_ReadCompareValue:                    ; this name deprecated
_wTimer16_3_ReadCompareValue:                    ; this name deprecated
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[Timer16_3_COMPARE_MSB_REG]
   mov   X, A
   mov   A, reg[Timer16_3_COMPARE_LSB_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer16_3_wReadTimerSaveCV
;
;  DESCRIPTION:
...
;
 Timer16_3_wReadTimerSaveCV:
_Timer16_3_wReadTimerSaveCV:
 wTimer16_3_ReadTimerSaveCV:                     ; this name deprecated
_wTimer16_3_ReadTimerSaveCV:                     ; this name deprecated
 wTimer16_3_ReadCounter:                         ; this name deprecated
_wTimer16_3_ReadCounter:                         ; this name deprecated
...
wCount_LSB:    equ   2
   ...
   mov   A, reg[Timer16_3_CONTROL_LSB_REG]       ; save the Control register
   push  A
   mov   A, reg[Timer16_3_COMPARE_LSB_REG]       ; save the Compare register
   push  A
   mov   A, reg[Timer16_3_COMPARE_MSB_REG]
   push  A
   mov   A, reg[Timer16_3_COUNTER_LSB_REG]       ; synchronous copy DR2 <- DR0
                                                 ; This may cause an interrupt!
   mov   A, reg[Timer16_3_COMPARE_MSB_REG]       ; Now grab DR2 (DR0) and save
   mov   [X+wCount_MSB], A
   mov   A, reg[Timer16_3_COMPARE_LSB_REG]
   mov   [X+wCount_LSB], A
...
.SetupStatusFlag:                                ; and ...
   ...
   Timer16_3_Stop_M                              ; Disable (stop) the timer
   pop   A                                       ; Restore the Compare register
   mov   reg[Timer16_3_COMPARE_MSB_REG], A
   pop   A
   mov   reg[Timer16_3_COMPARE_LSB_REG], A
   pop   A                                       ; restore start state of the timer
   mov   reg[Timer16_3_CONTROL_LSB_REG], A
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer16_3_wReadTimer
;
;  DESCRIPTION:
...
;
 Timer16_3_wReadTimer:
_Timer16_3_wReadTimer:
 wTimer16_3_ReadTimer:                           ; this name deprecated
_wTimer16_3_ReadTimer:                           ; this name deprecated
 wTimer16_3_CaptureCounter:                      ; this name deprecated
_wTimer16_3_CaptureCounter:                      ; this name deprecated

   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[Timer16_3_COUNTER_LSB_REG]       ; synchronous copy DR2 <- DR0
                                                 ; This may cause an interrupt!

   mov   A, reg[Timer16_3_COMPARE_MSB_REG]       ; Return DR2 (actually DR0)
   mov   X, A
   mov   A, reg[Timer16_3_COMPARE_LSB_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
