...
;  Global Symbols
;-----------------------------------------------
export   RX8_3_EnableInt
export  _RX8_3_EnableInt
export   RX8_3_DisableInt
export  _RX8_3_DisableInt
export   RX8_3_Start
export  _RX8_3_Start
export   RX8_3_Stop
export  _RX8_3_Stop
export   RX8_3_bReadRxData
export  _RX8_3_bReadRxData
export   RX8_3_bReadRxStatus
export  _RX8_3_bReadRxStatus

; Old function name convension, do not use.
; These will be removed in a future release.
export  bRX8_3_ReadRxData
export _bRX8_3_ReadRxData
export  bRX8_3_ReadRxStatus
export _bRX8_3_ReadRxStatus

;-----------------------------------------------
; High Level RX functions
;-----------------------------------------------

export  RX8_3_cGetChar
export _RX8_3_cGetChar
export  RX8_3_cReadChar
export _RX8_3_cReadChar
export  RX8_3_iReadChar
export _RX8_3_iReadChar

IF (RX8_3_RXBUF_ENABLE)
export  RX8_3_CmdReset
export _RX8_3_CmdReset
export  RX8_3_bCmdCheck
export _RX8_3_bCmdCheck
export  RX8_3_bCmdLength
export _RX8_3_bCmdLength
export  RX8_3_bErrCheck
export _RX8_3_bErrCheck

export  RX8_3_szGetParam
export _RX8_3_szGetParam
export  RX8_3_szGetRestOfParams
export _RX8_3_szGetRestOfParams
...
_RX8_3_EnableInt:
   ...
   M8C_EnableIntMask RX8_3_INT_REG, RX8_3_bINT_MASK
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: RX8_3_DisableInt
;
;  DESCRIPTION:
...
_RX8_3_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   M8C_DisableIntMask RX8_3_INT_REG, RX8_3_bINT_MASK
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: RX8_3_Start(BYTE bParity)
;
;  DESCRIPTION:
...
_RX8_3_Stop:
   RAM_PROLOGUE RAM_USE_CLASS_1
   and   REG[RX8_3_CONTROL_REG], ~bfCONTROL_REG_START_BIT
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: RX8_3_bReadRxData
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: RX8_3_bReadRxStatus
;
;  DESCRIPTION:
...
;
 RX8_3_bReadRxStatus:
_RX8_3_bReadRxStatus:
 bRX8_3_ReadRxStatus:
_bRX8_3_ReadRxStatus:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov A,  REG[RX8_3_CONTROL_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.getChar_Loop:
   tst REG[RX8_3_CONTROL_REG],RX8_3_RX_REG_FULL  ; Check if a character is ready
   jz  .getChar_Loop                                        ; If not loop

   mov A, REG[RX8_3_RX_BUFFER_REG]               ; Get character
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
_RX8_3_cReadChar:
   ...
   mov  A,REG[RX8_3_CONTROL_REG]                           ; Get Status of RX
   push A
   and  A,RX8_3_RX_COMPLETE                                ; Check if a character is ready
   jnz  .RX_DATA_RDY                                       ; Data Ready go read it.
   pop  A
   jmp  .RX_NO_VALID_CHAR

.RX_DATA_RDY:
   mov  A,REG[RX8_3_RX_BUFFER_REG]                         ; Read data first, then
   swap A,X                                                ; determine if data is valid

   pop  A                                                  ; Check for errors
   and  A,(RX8_3_RX_PARITY_ERROR | RX8_3_RX_FRAMING_ERROR)
...
_RX8_3_iReadChar:
   ...
   and  A,(RX8_3_RX_ERROR|RX8_3_RX_REG_FULL)
   push A
   and  A,RX8_3_RX_COMPLETE                                ; Check if a character is ready
   jnz  .RX_GET_DATA                                       ; Data Ready go read it.
   pop  A
   or   A,RX8_3_RX_NO_DATA                                 ; Add no data flag
   swap A,X
   jmp  End_RX8_3_iReadChar
...
_RX8_3_CmdReset:
   ...
   RAM_SETPAGE_CUR >RX8_3_aRxBuffer
   mov [RX8_3_aRxBuffer], 0x00
   RAM_SETPAGE_CUR >ptrParam
   mov [ptrParam],0x00
   RAM_SETPAGE_CUR >RX8_3_bRxCnt
   mov [RX8_3_bRxCnt], 0x00
   and [RX8_3_fStatus], 0x00
...
_RX8_3_bCmdCheck:
   RAM_PROLOGUE RAM_USE_CLASS_4
   RAM_SETPAGE_CUR >RX8_3_fStatus
   mov A,  [RX8_3_fStatus]
   and A, RX8_3_RX_BUF_CMDTERM                   ; Mask off Command status
   RAM_EPILOGUE RAM_USE_CLASS_4
   ret
.ENDSECTION
...
_RX8_3_bErrCheck:
   ...
   RAM_SETPAGE_CUR >RX8_3_fStatus
   mov A,  [RX8_3_fStatus]
   and A, RX8_3_RX_BUF_ERROR                     ; Mask off Error status
   and [RX8_3_fStatus], ~RX8_3_RX_BUF_ERROR
   RAM_EPILOGUE RAM_USE_CLASS_4
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: RX8_3_bCmdLength
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: RX8_3_szGetParam
;
;  DESCRIPTION:
...
;     RX8_3_CmdReset which resets the entire buffer to the 'empty'
;     state. Typically this function, RX8_3_szGetParam, is
...
_RX8_3_szGetParam:
   ...
   mov  A, <RX8_3_aRxBuffer                 ; Get address to receive buffer
...
.CheckForDelim:
    cmp  A,RX8_3_DELIMITER                  ; Check if we have a delimiter
    jnz  .ParamStartFound
    inc  X                                  ; Increment both current pointer and
    inc  [ptrParam]                         ; stored pointer.
    mov  A,[X]                              ; Get character pointed by X
    cmp  [ptrParam],(RX8_3_RX_BUFFER_SIZE -1)  ; Check if we are at the end of buffer
    jnz  .CheckForDelim
                                            ; End of string found
.EndOfString:
    push X                                  ; Save ptr
...
.ParamLoop:
    ...
    mov  [ptrParam],(RX8_3_RX_BUFFER_SIZE -1)  ; Reset pointer to end of string.
...
.NotNullString:
   pop  X
   mov  A,>RX8_3_aRxBuffer                     ; Return pointer
   RAM_EPILOGUE RAM_USE_CLASS_3
   RAM_EPILOGUE RAM_USE_CLASS_4
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: RX8_3_szGetRestOfParams
;
;  DESCRIPTION:
...
;          CUR_PP
;
 RX8_3_szGetRestOfParams:
_RX8_3_szGetRestOfParams:
   RAM_PROLOGUE RAM_USE_CLASS_4
   RAM_SETPAGE_CUR >ptrParam
