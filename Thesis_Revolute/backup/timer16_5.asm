...
;  Global Symbols
;-----------------------------------------------
export  Timer16_5_EnableInt
export _Timer16_5_EnableInt
export  Timer16_5_DisableInt
export _Timer16_5_DisableInt
export  Timer16_5_Start
export _Timer16_5_Start
export  Timer16_5_Stop
export _Timer16_5_Stop
export  Timer16_5_WritePeriod
export _Timer16_5_WritePeriod
export  Timer16_5_WriteCompareValue
export _Timer16_5_WriteCompareValue
export  Timer16_5_wReadCompareValue
export _Timer16_5_wReadCompareValue
export  Timer16_5_wReadTimer
export _Timer16_5_wReadTimer
export  Timer16_5_wReadTimerSaveCV
export _Timer16_5_wReadTimerSaveCV

; The following functions are deprecated and subject to omission in future releases
;
export  wTimer16_5_ReadCompareValue  ; deprecated
export _wTimer16_5_ReadCompareValue  ; deprecated
export  wTimer16_5_ReadTimer         ; deprecated
export _wTimer16_5_ReadTimer         ; deprecated
export  wTimer16_5_ReadTimerSaveCV   ; deprecated
export _wTimer16_5_ReadTimerSaveCV   ; deprecated

export  wTimer16_5_ReadCounter       ; obsolete
export _wTimer16_5_ReadCounter       ; obsolete
export  wTimer16_5_CaptureCounter    ; obsolete
export _wTimer16_5_CaptureCounter    ; obsolete
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer16_5_EnableInt
;
;  DESCRIPTION:
...
;
 Timer16_5_EnableInt:
_Timer16_5_EnableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   Timer16_5_EnableInt_M
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer16_5_DisableInt
;
;  DESCRIPTION:
...
;    functions.
;
 Timer16_5_DisableInt:
_Timer16_5_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   Timer16_5_DisableInt_M
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer16_5_WritePeriod
;
;  DESCRIPTION:
...
;    functions.
;
 Timer16_5_WritePeriod:
_Timer16_5_WritePeriod:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[Timer16_5_PERIOD_LSB_REG], A
   mov   A, X
   mov   reg[Timer16_5_PERIOD_MSB_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
;    functions.
;
 Timer16_5_WriteCompareValue:
_Timer16_5_WriteCompareValue:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[Timer16_5_COMPARE_LSB_REG], A
   mov   A, X
   mov   reg[Timer16_5_COMPARE_MSB_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer16_5_wReadCompareValue
;
;  DESCRIPTION:
...
;    functions.
;
 Timer16_5_wReadCompareValue:
_Timer16_5_wReadCompareValue:
 wTimer16_5_ReadCompareValue:                    ; this name deprecated
_wTimer16_5_ReadCompareValue:                    ; this name deprecated
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[Timer16_5_COMPARE_MSB_REG]
   mov   X, A
   mov   A, reg[Timer16_5_COMPARE_LSB_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer16_5_wReadTimerSaveCV
;
;  DESCRIPTION:
...
;
 Timer16_5_wReadTimerSaveCV:
_Timer16_5_wReadTimerSaveCV:
 wTimer16_5_ReadTimerSaveCV:                     ; this name deprecated
_wTimer16_5_ReadTimerSaveCV:                     ; this name deprecated
 wTimer16_5_ReadCounter:                         ; this name deprecated
_wTimer16_5_ReadCounter:                         ; this name deprecated
...
wCount_LSB:    equ   2
   ...
   mov   A, reg[Timer16_5_CONTROL_LSB_REG]       ; save the Control register
   push  A
   mov   A, reg[Timer16_5_COMPARE_LSB_REG]       ; save the Compare register
   push  A
   mov   A, reg[Timer16_5_COMPARE_MSB_REG]
   push  A
   mov   A, reg[Timer16_5_COUNTER_LSB_REG]       ; synchronous copy DR2 <- DR0
                                                 ; This may cause an interrupt!
   mov   A, reg[Timer16_5_COMPARE_MSB_REG]       ; Now grab DR2 (DR0) and save
   mov   [X+wCount_MSB], A
   mov   A, reg[Timer16_5_COMPARE_LSB_REG]
   mov   [X+wCount_LSB], A
...
.SetupStatusFlag:                                ; and ...
   ...
   Timer16_5_Stop_M                              ; Disable (stop) the timer
   pop   A                                       ; Restore the Compare register
   mov   reg[Timer16_5_COMPARE_MSB_REG], A
   pop   A
   mov   reg[Timer16_5_COMPARE_LSB_REG], A
   pop   A                                       ; restore start state of the timer
   mov   reg[Timer16_5_CONTROL_LSB_REG], A
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer16_5_wReadTimer
;
;  DESCRIPTION:
...
;
 Timer16_5_wReadTimer:
_Timer16_5_wReadTimer:
 wTimer16_5_ReadTimer:                           ; this name deprecated
_wTimer16_5_ReadTimer:                           ; this name deprecated
 wTimer16_5_CaptureCounter:                      ; this name deprecated
_wTimer16_5_CaptureCounter:                      ; this name deprecated

   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[Timer16_5_COUNTER_LSB_REG]       ; synchronous copy DR2 <- DR0
                                                 ; This may cause an interrupt!

   mov   A, reg[Timer16_5_COMPARE_MSB_REG]       ; Return DR2 (actually DR0)
   mov   X, A
   mov   A, reg[Timer16_5_COMPARE_LSB_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
