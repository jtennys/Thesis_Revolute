...
include "m8c.inc"
include "memory.inc"
include "Timer16_6.inc"

;-----------------------------------------------
;  Global Symbols
;-----------------------------------------------
export  Timer16_6_EnableInt
export _Timer16_6_EnableInt
export  Timer16_6_DisableInt
export _Timer16_6_DisableInt
export  Timer16_6_Start
export _Timer16_6_Start
export  Timer16_6_Stop
export _Timer16_6_Stop
export  Timer16_6_WritePeriod
export _Timer16_6_WritePeriod
export  Timer16_6_WriteCompareValue
export _Timer16_6_WriteCompareValue
export  Timer16_6_wReadCompareValue
export _Timer16_6_wReadCompareValue
export  Timer16_6_wReadTimer
export _Timer16_6_wReadTimer
export  Timer16_6_wReadTimerSaveCV
export _Timer16_6_wReadTimerSaveCV

; The following functions are deprecated and subject to omission in future releases
;
export  wTimer16_6_ReadCompareValue  ; deprecated
export _wTimer16_6_ReadCompareValue  ; deprecated
export  wTimer16_6_ReadTimer         ; deprecated
export _wTimer16_6_ReadTimer         ; deprecated
export  wTimer16_6_ReadTimerSaveCV   ; deprecated
export _wTimer16_6_ReadTimerSaveCV   ; deprecated

export  wTimer16_6_ReadCounter       ; obsolete
export _wTimer16_6_ReadCounter       ; obsolete
export  wTimer16_6_CaptureCounter    ; obsolete
export _wTimer16_6_CaptureCounter    ; obsolete
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer16_6_EnableInt
;
;  DESCRIPTION:
...
;
 Timer16_6_EnableInt:
_Timer16_6_EnableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   Timer16_6_EnableInt_M
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer16_6_DisableInt
;
;  DESCRIPTION:
...
;    functions.
;
 Timer16_6_DisableInt:
_Timer16_6_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   Timer16_6_DisableInt_M
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer16_6_WritePeriod
;
;  DESCRIPTION:
...
;    functions.
;
 Timer16_6_WritePeriod:
_Timer16_6_WritePeriod:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[Timer16_6_PERIOD_LSB_REG], A
   mov   A, X
   mov   reg[Timer16_6_PERIOD_MSB_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
;    functions.
;
 Timer16_6_WriteCompareValue:
_Timer16_6_WriteCompareValue:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[Timer16_6_COMPARE_LSB_REG], A
   mov   A, X
   mov   reg[Timer16_6_COMPARE_MSB_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer16_6_wReadCompareValue
;
;  DESCRIPTION:
...
;    functions.
;
 Timer16_6_wReadCompareValue:
_Timer16_6_wReadCompareValue:
 wTimer16_6_ReadCompareValue:                    ; this name deprecated
_wTimer16_6_ReadCompareValue:                    ; this name deprecated
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[Timer16_6_COMPARE_MSB_REG]
   mov   X, A
   mov   A, reg[Timer16_6_COMPARE_LSB_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer16_6_wReadTimerSaveCV
;
;  DESCRIPTION:
...
;
 Timer16_6_wReadTimerSaveCV:
_Timer16_6_wReadTimerSaveCV:
 wTimer16_6_ReadTimerSaveCV:                     ; this name deprecated
_wTimer16_6_ReadTimerSaveCV:                     ; this name deprecated
 wTimer16_6_ReadCounter:                         ; this name deprecated
_wTimer16_6_ReadCounter:                         ; this name deprecated
...
wCount_LSB:    equ   2
   ...
   mov   A, reg[Timer16_6_CONTROL_LSB_REG]       ; save the Control register
   push  A
   mov   A, reg[Timer16_6_COMPARE_LSB_REG]       ; save the Compare register
   push  A
   mov   A, reg[Timer16_6_COMPARE_MSB_REG]
   push  A
   mov   A, reg[Timer16_6_COUNTER_LSB_REG]       ; synchronous copy DR2 <- DR0
                                                 ; This may cause an interrupt!
   mov   A, reg[Timer16_6_COMPARE_MSB_REG]       ; Now grab DR2 (DR0) and save
   mov   [X+wCount_MSB], A
   mov   A, reg[Timer16_6_COMPARE_LSB_REG]
   mov   [X+wCount_LSB], A
...
.SetupStatusFlag:                                ; and ...
   ...
   Timer16_6_Stop_M                              ; Disable (stop) the timer
   pop   A                                       ; Restore the Compare register
   mov   reg[Timer16_6_COMPARE_MSB_REG], A
   pop   A
   mov   reg[Timer16_6_COMPARE_LSB_REG], A
   pop   A                                       ; restore start state of the timer
   mov   reg[Timer16_6_CONTROL_LSB_REG], A
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer16_6_wReadTimer
;
;  DESCRIPTION:
...
;
 Timer16_6_wReadTimer:
_Timer16_6_wReadTimer:
 wTimer16_6_ReadTimer:                           ; this name deprecated
_wTimer16_6_ReadTimer:                           ; this name deprecated
 wTimer16_6_CaptureCounter:                      ; this name deprecated
_wTimer16_6_CaptureCounter:                      ; this name deprecated

   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[Timer16_6_COUNTER_LSB_REG]       ; synchronous copy DR2 <- DR0
                                                 ; This may cause an interrupt!

   mov   A, reg[Timer16_6_COMPARE_MSB_REG]       ; Return DR2 (actually DR0)
   mov   X, A
   mov   A, reg[Timer16_6_COMPARE_LSB_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
